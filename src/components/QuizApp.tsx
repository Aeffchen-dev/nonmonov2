                ...
                {index === 0 && char === 'N' ? (
                  ...
                  <div 
                    ...
                    style={{
                      ...
                      height: '16px',
                      position: 'relative',
                      transform: `rotate(${loading ? '0deg' : (baseSmileyRotation + (isDragging ? -(dragOffset / window.innerWidth) * 360 : 0))}deg)`,
                      transition: loading ? 'none' : (isDragging ? 'none' : 'transform 0.3s ease-in-out'),
                      verticalAlign: 'middle',
                      marginLeft: '0px'
                    }}
                  >
